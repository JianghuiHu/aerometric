...
The MIT license in the release package covers code and documentation only. Model files, Blender sources, textures, screenshots, and renders require separate permission.
